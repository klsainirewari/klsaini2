    ...
    <section className="py-20 bg-emerald-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Happy Investors</h2>
          <p className="text-lg text-gray-600">Don't just take our word for it. Here is what our clients say.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t) => (
            <div key={t.id} className="bg-white p-8 rounded-xl shadow-md relative">
              <div className="absolute top-0 right-0 -mt-4 -mr-4 bg-emerald-600 text-white p-2 rounded-full">
